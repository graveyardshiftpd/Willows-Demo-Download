 ...
 * @text Extract Text
 * @type boolean
 * @desc Extracts text from games (choose what to extract below). Don't forget to turn this false when you release your game
 * @default false
 * 
 * @param decor1
 * @text ==========================
    ...
    function updateMessagesCSV() {
        ...
        existingContent.slice(1).forEach(row => {
            ...
            if (!updatedMessages.has(originalText) &&
                ...
                // All translations witg correct indices

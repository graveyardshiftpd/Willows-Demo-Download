//============================================================================
// IAVRA_MasterLocalization.js แปลภาษาไทยโดย Wisarut Perunawin วิศรุต เปรุนาวิน
//============================================================================

/*:
@plugindesc Fusion of Iavra Localization Core and Menu, with bug fixes.
<Iavra Master Localization>
@author Iavra
...
อนุญาตให้ใช้งานในเชิญพาณิชย์ได้ แต่ต้องให้เครดิต Iavra, Eliaquim และ Wisarut Perunawin วิศรุต เปรุนาวิน
Free for commercial and non-commercial.
As long you credit Iavra, Eliaquim and Wisarut Perunawin.
...
Imported.IAVRA_MasterLocalization = true;

var IAVRA = IAVRA || {};
IAVRA.MasterLocalization = IAVRA.MasterLocalization || {};


IAVRA.MasterLocalization.Parameters = PluginManager.parameters('IAVRA_MasterLocalization');
...
IAVRA.Window_Options_initialize = Window_Options.prototype.initialize;
